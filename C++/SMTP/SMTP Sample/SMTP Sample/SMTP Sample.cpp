// SMTP Sample.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    oSmtp->FromAddr = _T("gonderen e postasi");

    // Add recipient email address
    oSmtp->AddRecipientEx(_T("alici e postasi"), 0);
    ...
    oSmtp->UserName = _T("gonderen e postasi");
