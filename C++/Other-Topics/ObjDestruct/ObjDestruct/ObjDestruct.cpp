// ObjDestruct.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
Singleton* Singleton::getInstance(const string& value) {
    if (singleton_ == nullptr) {
        ...
        cout << "obje olusturulamaz" << endl;
        try {
            string err = "izinsiz erisim";
            throw(err);
        }
        catch (string err) {
            cout << err << endl;
...
{
    newClass obj;
    cout << obj.singletonObj->value() << endl;
    //Singleton* singletonObj = Singleton::getInstance("Singleton");
